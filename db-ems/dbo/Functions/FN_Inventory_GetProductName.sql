...
**/
CREATE FUNCTION [dbo].[FN_Inventory_GetProductName] (
@inventoryTypeId INT,
...
BEGIN
	...
	DECLARE  @inventoryAttributes TABLE (
		modelNo VARCHAR(50),
        color VARCHAR(50),
        colorName VARCHAR(50),
        netHeight VARCHAR(50),
        netLength VARCHAR(50),
        netWidth VARCHAR(50),
        inventoryType VARCHAR(50),
        boardGrade VARCHAR(50),
        grammage  VARCHAR(50),
        edgingType  VARCHAR(50),
        surface  VARCHAR(50),
        backerType  VARCHAR(50),
        ...
        INSERT INTO @inventoryAttributes
	    SELECT 
    ...
    RETURN REPLACE(REPLACE(REPLACE(@productName, '[space]', ' '), '[,]', ','), '+', '')
