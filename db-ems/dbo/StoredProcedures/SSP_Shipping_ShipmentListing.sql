...
N'{"list":[{"companyId":4,"customerId":0,"shipStartDate":"2025-05-17","shipEndDate":"2025-06-16","rowStart":1,"pageRow":100, "sortBy":2, "search":"013"}]}'

**/
 
CREATE PROCEDURE [dbo].[SSP_Shipping_ShipmentListing]
@json NVARCHAR(MAX)
AS
BEGIN
    /** sortBy
